...
const MobileNav = ({ showNav, closeNav }: Props) => {
  ...
  return (
    <div>
      ...
      {/* Nav links */}
      <div
        className={`text-white fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-cyan-800 space-y-6 z-[1000050] right-0 ${navOpen}`}
      >
        {NavLinks.map((link) => (
